...
cl %CFLAGS% /c src\Shared_modules\AntiEvasion\DebuggerEvasionDetector.cpp    /Fobuild\ae_obj\DebuggerEvasionDetector.obj
if %errorlevel% neq 0 ( echo [ERROR] DebuggerEvasionDetector.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\AntiEvasion\VMEvasionDetector.cpp          /Fobuild\ae_obj\VMEvasionDetector.obj
...
cl %CFLAGS% /c src\Shared_modules\PEParser\PEParser.cpp                      /Fobuild\ae_obj\PEParser.obj
if %errorlevel% neq 0 ( echo [ERROR] PEParser.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\PEParser\PEValidation.cpp                  /Fobuild\ae_obj\PEValidation.obj
if %errorlevel% neq 0 ( echo [ERROR] PEValidation.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\HashStore\HashStore.cpp                    /Fobuild\ae_obj\HashStore.obj
if %errorlevel% neq 0 ( echo [ERROR] HashStore.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\HashStore\BloomFilter_impl.cpp             /Fobuild\ae_obj\BloomFilter_impl.obj
if %errorlevel% neq 0 ( echo [ERROR] BloomFilter_impl.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\HashStore\HashBucket_impl.cpp              /Fobuild\ae_obj\HashBucket_impl.obj
if %errorlevel% neq 0 ( echo [ERROR] HashBucket_impl.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\HashStore\HashStore_import_export.cpp      /Fobuild\ae_obj\HashStore_import_export.obj
if %errorlevel% neq 0 ( echo [ERROR] HashStore_import_export.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\HashStore\HashStore_mgnmnt.cpp             /Fobuild\ae_obj\HashStore_mgnmnt.obj
if %errorlevel% neq 0 ( echo [ERROR] HashStore_mgnmnt.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\HashStore\HashStore_query_operations.cpp   /Fobuild\ae_obj\HashStore_query_operations.obj
if %errorlevel% neq 0 ( echo [ERROR] HashStore_query_operations.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\PatternStore\PatternIndex.cpp              /Fobuild\ae_obj\PatternIndex.obj
if %errorlevel% neq 0 ( echo [ERROR] PatternIndex.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\PatternStore\PatternStore.cpp              /Fobuild\ae_obj\PatternStore.obj
if %errorlevel% neq 0 ( echo [ERROR] PatternStore.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\PatternStore\SIMD_matcher_impl.cpp         /Fobuild\ae_obj\SIMD_matcher_impl.obj
if %errorlevel% neq 0 ( echo [ERROR] SIMD_matcher_impl.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\PatternStore\aho_crsck_impl.cpp            /Fobuild\ae_obj\aho_crsck_impl.obj
if %errorlevel% neq 0 ( echo [ERROR] aho_crsck_impl.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\PatternStore\boyer_moore_impl.cpp          /Fobuild\ae_obj\boyer_moore_impl.obj
if %errorlevel% neq 0 ( echo [ERROR] boyer_moore_impl.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\FuzzyHasher\FuzzyHasher.cpp                /Fobuild\ae_obj\FuzzyHasher.obj
if %errorlevel% neq 0 ( echo [ERROR] FuzzyHasher.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\FuzzyHasher\DigestGenerator.cpp            /Fobuild\ae_obj\DigestGenerator.obj
if %errorlevel% neq 0 ( echo [ERROR] DigestGenerator.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\FuzzyHasher\DigestComparer.cpp             /Fobuild\ae_obj\DigestComparer.obj
if %errorlevel% neq 0 ( echo [ERROR] DigestComparer.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\External\tlsh\tlsh.cpp                     /Fobuild\ae_obj\tlsh.obj
if %errorlevel% neq 0 ( echo [ERROR] tlsh.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\External\tlsh\tlsh_impl.cpp                /Fobuild\ae_obj\tlsh_impl.obj
if %errorlevel% neq 0 ( echo [ERROR] tlsh_impl.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\External\tlsh\tlsh_util.cpp                /Fobuild\ae_obj\tlsh_util.obj
if %errorlevel% neq 0 ( echo [ERROR] tlsh_util.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\External\tlsh\shared_file_functions.cpp    /Fobuild\ae_obj\shared_file_functions.obj
if %errorlevel% neq 0 ( echo [ERROR] shared_file_functions.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\External\tlsh\input_desc.cpp               /Fobuild\ae_obj\input_desc.obj
if %errorlevel% neq 0 ( echo [ERROR] input_desc.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\External\pugixml\pugixml.cpp               /Fobuild\ae_obj\pugixml.obj
if %errorlevel% neq 0 ( echo [ERROR] pugixml.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureFormat.cpp          /Fobuild\ae_obj\SignatureFormat.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureFormat.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureBuilder.cpp         /Fobuild\ae_obj\SignatureBuilder.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureBuilder.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\batch_sig_builder.cpp        /Fobuild\ae_obj\batch_sig_builder.obj
if %errorlevel% neq 0 ( echo [ERROR] batch_sig_builder.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureIndex.cpp           /Fobuild\ae_obj\SignatureIndex.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureIndex.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureIndex_COW.cpp       /Fobuild\ae_obj\SignatureIndex_COW.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureIndex_COW.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureIndex_Cache_mngmnt.cpp /Fobuild\ae_obj\SignatureIndex_Cache_mngmnt.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureIndex_Cache_mngmnt.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureIndex_modification.cpp /Fobuild\ae_obj\SignatureIndex_modification.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureIndex_modification.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureIndex_Query.cpp     /Fobuild\ae_obj\SignatureIndex_Query.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureIndex_Query.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureIndex_stat_maintenance.cpp /Fobuild\ae_obj\SignatureIndex_stat_maintenance.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureIndex_stat_maintenance.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureStore.cpp           /Fobuild\ae_obj\SignatureStore.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureStore.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureStore_mngmnt.cpp    /Fobuild\ae_obj\SignatureStore_mngmnt.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureStore_mngmnt.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureStore_Query.cpp     /Fobuild\ae_obj\SignatureStore_Query.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureStore_Query.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\SignatureStore_scan.cpp      /Fobuild\ae_obj\SignatureStore_scan.obj
if %errorlevel% neq 0 ( echo [ERROR] SignatureStore_scan.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\sig_builder_import_methods.cpp /Fobuild\ae_obj\sig_builder_import_methods.obj
if %errorlevel% neq 0 ( echo [ERROR] sig_builder_import_methods.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\sig_builder_input_methods.cpp /Fobuild\ae_obj\sig_builder_input_methods.obj
if %errorlevel% neq 0 ( echo [ERROR] sig_builder_input_methods.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\sig_builder_serialization.cpp /Fobuild\ae_obj\sig_builder_serialization.obj
if %errorlevel% neq 0 ( echo [ERROR] sig_builder_serialization.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\sig_builder_utils.cpp        /Fobuild\ae_obj\sig_builder_utils.obj
if %errorlevel% neq 0 ( echo [ERROR] sig_builder_utils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\sig_indx_internal_node_mng.cpp /Fobuild\ae_obj\sig_indx_internal_node_mng.obj
if %errorlevel% neq 0 ( echo [ERROR] sig_indx_internal_node_mng.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\SignatureStore\YaraRuleStore.cpp            /Fobuild\ae_obj\YaraRuleStore.obj
if %errorlevel% neq 0 ( echo [ERROR] YaraRuleStore.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelStore.cpp           /Fobuild\ae_obj\ThreatIntelStore.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelStore.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelLookup.cpp          /Fobuild\ae_obj\ThreatIntelLookup.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelLookup.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelIOCManager.cpp      /Fobuild\ae_obj\ThreatIntelIOCManager.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelIOCManager.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelIndex_URLMatcher.cpp /Fobuild\ae_obj\ThreatIntelIndex_URLMatcher.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelIndex_URLMatcher.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelIndex_Trees.cpp     /Fobuild\ae_obj\ThreatIntelIndex_Trees.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelIndex_Trees.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelIndex_Modifications.cpp /Fobuild\ae_obj\ThreatIntelIndex_Modifications.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelIndex_Modifications.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelIndex_Lookups.cpp   /Fobuild\ae_obj\ThreatIntelIndex_Lookups.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelIndex_Lookups.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelIndex_DataStructures.cpp /Fobuild\ae_obj\ThreatIntelIndex_DataStructures.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelIndex_DataStructures.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelIndex_Core.cpp      /Fobuild\ae_obj\ThreatIntelIndex_Core.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelIndex_Core.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelImporter.cpp        /Fobuild\ae_obj\ThreatIntelImporter.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelImporter.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelFormat.cpp          /Fobuild\ae_obj\ThreatIntelFormat.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelFormat.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelFeedManager_parsers.cpp /Fobuild\ae_obj\ThreatIntelFeedManager_parsers.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelFeedManager_parsers.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelFeedManager.cpp     /Fobuild\ae_obj\ThreatIntelFeedManager.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelFeedManager.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelExporter.cpp        /Fobuild\ae_obj\ThreatIntelExporter.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelExporter.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelDatabase.cpp        /Fobuild\ae_obj\ThreatIntelDatabase.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelDatabase.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ThreatIntelBloomFilter.cpp     /Fobuild\ae_obj\ThreatIntelBloomFilter.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreatIntelBloomFilter.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\ThreatIntel\ReputationCache.cpp            /Fobuild\ae_obj\ReputationCache.obj
if %errorlevel% neq 0 ( echo [ERROR] ReputationCache.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\Logger.cpp                           /Fobuild\ae_obj\Logger.obj
if %errorlevel% neq 0 ( echo [ERROR] Logger.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\StringUtils.cpp                      /Fobuild\ae_obj\StringUtils.obj
if %errorlevel% neq 0 ( echo [ERROR] StringUtils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\HashUtils.cpp                        /Fobuild\ae_obj\HashUtils.obj
if %errorlevel% neq 0 ( echo [ERROR] HashUtils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\FileUtils.cpp                        /Fobuild\ae_obj\FileUtils.obj
if %errorlevel% neq 0 ( echo [ERROR] FileUtils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\JSONUtils.cpp                        /Fobuild\ae_obj\JSONUtils.obj
if %errorlevel% neq 0 ( echo [ERROR] JSONUtils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\RegistryUtils.cpp                    /Fobuild\ae_obj\RegistryUtils.obj
if %errorlevel% neq 0 ( echo [ERROR] RegistryUtils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\MemoryUtils.cpp                      /Fobuild\ae_obj\MemoryUtils.obj
if %errorlevel% neq 0 ( echo [ERROR] MemoryUtils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\ProcessUtils.cpp                     /Fobuild\ae_obj\ProcessUtils.obj
if %errorlevel% neq 0 ( echo [ERROR] ProcessUtils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\SystemUtils.cpp                      /Fobuild\ae_obj\SystemUtils.obj
if %errorlevel% neq 0 ( echo [ERROR] SystemUtils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\Timer.cpp                            /Fobuild\ae_obj\Timer.obj
if %errorlevel% neq 0 ( echo [ERROR] Timer.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\ThreadPool.cpp                       /Fobuild\ae_obj\ThreadPool.obj
if %errorlevel% neq 0 ( echo [ERROR] ThreadPool.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\Base64Utils.cpp                      /Fobuild\ae_obj\Base64Utils.obj
if %errorlevel% neq 0 ( echo [ERROR] Base64Utils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\NetworkUtils.cpp                     /Fobuild\ae_obj\NetworkUtils.obj
if %errorlevel% neq 0 ( echo [ERROR] NetworkUtils.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\NetworkUtils_http_https.cpp          /Fobuild\ae_obj\NetworkUtils_http_https.obj
if %errorlevel% neq 0 ( echo [ERROR] NetworkUtils_http_https.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\NetworkUtils_DNS.cpp                 /Fobuild\ae_obj\NetworkUtils_DNS.obj
if %errorlevel% neq 0 ( echo [ERROR] NetworkUtils_DNS.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\NetworkUtils_Adapter.cpp             /Fobuild\ae_obj\NetworkUtils_Adapter.obj
if %errorlevel% neq 0 ( echo [ERROR] NetworkUtils_Adapter.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\NetworkUtilsIpAddress.cpp            /Fobuild\ae_obj\NetworkUtilsIpAddress.obj
if %errorlevel% neq 0 ( echo [ERROR] NetworkUtilsIpAddress.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\NetworkUtilsMacAdress.cpp            /Fobuild\ae_obj\NetworkUtilsMacAdress.obj
if %errorlevel% neq 0 ( echo [ERROR] NetworkUtilsMacAdress.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\NetworkUtils_URL.cpp                 /Fobuild\ae_obj\NetworkUtils_URL.obj
if %errorlevel% neq 0 ( echo [ERROR] NetworkUtils_URL.cpp & exit /b 1 )

cl %CFLAGS% /c src\Shared_modules\Utils\NetworkUtils_proxy.cpp               /Fobuild\ae_obj\NetworkUtils_proxy.obj
