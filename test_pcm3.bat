...
cl.exe %CL_FLAGS% /c /Fo"C:\ShadowStrike\ShadowStrike\bin\pcm_test\ProcessCreationMonitor.obj" "C:\ShadowStrike\ShadowStrike\src\Shared_modules\RealTime\ProcessCreationMonitor.cpp"
